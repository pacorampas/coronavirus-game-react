...
export default class Borders {
  ...
  constructor(scene) {
    this.scene = scene
    this.borderUp = this.scene.physics.add.image(
    ...
    this.borderDown = this.scene.physics.add.image(
      this.scene.game.config.width / 2,
    ...
    this.borderLeft = this.scene.physics.add.image(
      0,
      this.scene.game.config.height / 2
    )
    this.borderLeft.setSize(
      this.BORDER_WIDTH,
      this.scene.game.config.height,
      true
    )
    ...
    this.bordersGroup = new Phaser.GameObjects.Group(this, [
      this.borderUp,
      this.borderDown,
      this.borderRight,
      this.borderLeft,
